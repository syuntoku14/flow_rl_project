...
class GAILTrainer(Trainer):
    ...
    def _init(self, config, env_name):
        ...
        try:
            ...
            print("expert_samples doesn't exist. You can't train")
        # set evaluators
    ...
    def _train(self):
        ...
        # set samles.count == expert_samples.count
        samples = samples.slice(0, self.expert_samples.count)
        ...
        self.set_state_dict()  # share the state_dict to evaluators
        return res
